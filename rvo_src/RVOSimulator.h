...
namespace RVO {
	...
	public:
		...
		size_t addAgentCoordinates(const float pos_x, const float pos_y);
		...
		size_t addAgentExt(const float pos_x, const float pos_y, 
						   float neighborDist,
						   size_t maxNeighbors, float timeHorizon,
						   float timeHorizonObst, float radius, float maxSpeed);
		...
		size_t addObstacleCoordinates(const std::vector<float>& vertices);
		...
		bool queryVisibilityCoordinates(const float point1_x, const float point1_y, 
		...
		void setAgentPositionCoordinates(size_t agentNo, const float position_x, const float position_y);
		...
		void setAgentPrefVelocityCoordinates(size_t agentNo, const float prefVelocity_x, const float prefVelocity_y);
		...
		void setAgentVelocityCoordinates(size_t agentNo, const float velocity_x, const float velocity_y);
